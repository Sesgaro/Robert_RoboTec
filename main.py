...
while True:
    try:
        ...
        if (new_trigger_left != trigger_left or new_trigger_right != trigger_right or
            ...
            last_data = motors.esp_magic(ESPvalue, motorFactors, trigger_left, trigger_right, grades_1, grades_2, last_data)
            print(f"Trigger Izq: {trigger_left} | Trigger Der: {trigger_right} | Joy1 X: {joy1_x} | Joy2 X: {joy2_x}")
    except KeyboardInterrupt:
        print("Programa terminado por el usuario")
        last_data = control_motors(motor_factors, 0, 0, last_data)
