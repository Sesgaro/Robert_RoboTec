...
// Semáforo para proteger el acceso a angles_msg y las variables de ángulo
SemaphoreHandle_t xAngleMutex = NULL;
  ...
  while (1) {
    ...
    if (xAngleMutex != NULL) {
      if (xSemaphoreTake(xAngleMutex, portMAX_DELAY) == pdTRUE) {
        ...
        Serial.println("Datos publicados en el tópico 'angles'");
      }
    }
